...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { hub_id: @merchant.hub_id, name: @merchant.name, representative_name: @merchant.representative_name, website: @merchant.website } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { hub_id: @merchant.hub_id, name: @merchant.name, representative_name: @merchant.representative_name, website: @merchant.website } }
